...
class GatewayApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GatewayBillingLog200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GatewayBillingLog200Response>> gatewayBillingLog({ 
    required GatewayBillingLogRequest gatewayBillingLogRequest,
    ...
    final _path = r'/gateway/billing/log';
    ...
    try {
      const _type = FullType(GatewayBillingLogRequest);
      _bodyData = _serializers.serialize(gatewayBillingLogRequest, specifiedType: _type);
    ...
    GatewayBillingLog200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GatewayBillingLog200Response),
      ) as GatewayBillingLog200Response;
    ...
    return Response<GatewayBillingLog200Response>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [apiSlug] - Gateway API slug identifier
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatCompletionResponse>> gatewayChatCompletions({ 
    ...
    final _path = r'/ai/gateway/{apiSlug}/chat/completions'.replaceAll('{' r'apiSlug' '}', encodeQueryParameter(_serializers, apiSlug, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [apiSlug] - Gateway API slug to scope the wallet query
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GatewayGetWallet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GatewayGetWallet200Response>> gatewayGetWallet({ 
    required String apiSlug,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/ai/gateway/me/wallet';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'api_slug': encodeQueryParameter(_serializers, apiSlug, const FullType(String)),
    };
    ...
    GatewayGetWallet200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GatewayGetWallet200Response),
      ) as GatewayGetWallet200Response;
    ...
    return Response<GatewayGetWallet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
