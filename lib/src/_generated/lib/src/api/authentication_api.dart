...
class AuthenticationApi {
  ...
  Future<Response<AuthResponse>> authSignin({ 
    ...
    try {
      const _type = FullType(AuthSigninRequest);
      _bodyData = _serializers.serialize(authSigninRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [AuthResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResponse>> authSignup({ 
    required AuthSignupRequest authSignupRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AuthSignupRequest);
      _bodyData = _serializers.serialize(authSignupRequest, specifiedType: _type);
